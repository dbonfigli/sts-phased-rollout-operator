...
//+kubebuilder:webhook:path=/mutate-sts-plus-v1alpha1-phasedrollout,mutating=true,failurePolicy=ignore,sideEffects=None,groups=sts.plus,resources=phasedrollouts,verbs=create;update,versions=v1alpha1,name=mphasedrollout.kb.io,admissionReviewVersions={v1,v1beta1}
...
//+kubebuilder:webhook:path=/validate-sts-plus-v1alpha1-phasedrollout,mutating=false,failurePolicy=ignore,sideEffects=None,groups=sts.plus,resources=phasedrollouts,verbs=create;update,versions=v1alpha1,name=vphasedrollout.kb.io,admissionReviewVersions={v1,v1beta1}
